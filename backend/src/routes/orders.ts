...
ordersRouter.get("/orders/:id/preview-pdf", ordersController.getPreviewPdf)
...
ordersRouter.patch("/orders/:id/shipping-fee", ordersController.updateShippingFee)
ordersRouter.patch("/orders/:id/deposit", ordersController.updateDeposit)
